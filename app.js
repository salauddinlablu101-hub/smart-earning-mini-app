...
function closeNotice() {
  ...
  try { sessionStorage.setItem("smart_earning_notice_seen","1"); } catch(e) {}
}

function setupNotice() {
  document.getElementById("group1").href = GROUP_1_URL;
  document.getElementById("group2").href = GROUP_2_URL;
  try {
    if (sessionStorage.getItem("smart_earning_notice_seen") === "1") {
      document.getElementById("noticeOverlay").classList.add("hidden");
    }
  } catch(e) {}
}
